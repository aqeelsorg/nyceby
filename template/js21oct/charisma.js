...
function docReady(){
	...
	$( ".collecteddatepicker" ).datepicker({
      changeMonth: true,
      changeYear: true,
	  minDate: -7,
	  maxDate: 0,
	...
	$( ".doseDatepicker" ).datepicker({
      changeMonth: true,
      changeYear: true,
	  minDate: 0,
	  dateFormat: 'dd-mm-yy',
    });
	$( ".consumDaepicker" ).datepicker({
      changeMonth: true,
      changeYear: true,
	  maxDate: 0,
	  dateFormat: 'dd-mm-yy',
...
*/
	...
	$('.btn-patient-medicine').click(function(e){
		e.preventDefault();
		$('#patient_medicine').modal('show');
	});
