<div class="posts left">
	...
	<?php if (!empty($posts)) : ?>
		...
		<div class="post">
			...
			<h2><a href="<?=$post->url."/".$post->id?>"><?=$post->title?></a></h2> 
			...
			<div class="post_content">
				<?=substr($post->excerpt_formatted,0,350)."....<a href=".$post->url."/".$post->id.">View More</a>";?> 
			</div>
			<div class="post_meta">
...
<div style="float: left;width: 80%;height: 65px;">
</div>