			...
			<?php if(count($products) > 0):?>
				...
				<?php foreach($products as $product):?>
					<li class="span3 product">
						...
						?>
						<a class="thumbnail" href="<?php echo site_url().'cart/product/'.$product->id;?>">
							<?php echo $photo; ?>
						</a>
						<h5 style="margin-top:5px;"><a href="<?php echo site_url().'cart/product/'.$product->id;?>"><?php echo $product->name;?></a></h5>
