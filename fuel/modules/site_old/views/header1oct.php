...
<div class="lan_pop" style="margin-left: 0px;width: 11%;">
 <ul id="nav">
...
<div class="wrapper" style="float:left;width:9%;">
<a href="#join_form" class="tag50" style="margin-left: 0px;margin-right: 5px;
   ">Join Free</a>
...
<div class="login_wrap">
        <a href="#login_form"><input type="button" value="Login" style="background: #222;width: 60%;
padding: 4px;border: 1px solid #4D4D4D;
border-radius: 3px;color: #FFF;height: 36px;
cursor: pointer; font-family:'Museo Sans 500';font-size: 11px;"/></a>
