...
Class Customer_model extends Base_module_model
{
	...
	{
			parent::__construct('pt_customers',SITE_FOLDER);
	}
	...
	*/
	...
	function is_logged_in($redirect = false, $default_redirect = 'user/login/')
	{
	...
	function save_group($data)
	{
        ...
        function add_my_comments($b_id,$message)
        {
