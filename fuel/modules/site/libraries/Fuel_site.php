...
{	
	...
	function __construct($params = array())
	{
		...
		$this->_CI->config->module_load('site', 'site');
	...
	function initialize($config = array())
	{
		...
		$this->_CI->load->module_model(SITE_FOLDER, 'customer_model');
		
		$this->_settings = $this->_CI->config->item('site');
	...
	{
		$this->_CI->load->module_model(SITE_FOLDER, 'product_model');
		
		$products = $this->_CI->product_model->products();
